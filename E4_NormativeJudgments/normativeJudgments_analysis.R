...
firm_mod <- lm(firm ~ cond + ai_knowledge_1, data = d_merged)
summary(firm_mod)
...
human_mod <- lm(human ~ cond + ai_knowledge_1, data = d_merged)
summary(human_mod)
...
ggsave("plots/LiabilityAscriptions.png", device = "png",width = 8.3, height = 4.3, units = "in")
